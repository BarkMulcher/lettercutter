    ...
    return (
        <div>
            <div className="shadow-lg card bg-light mb-3">
                ...
                <p className="card-body">
                    BELFAST RANGEWAY PROJECT

                    Belfast has 17 public shore access points or paths, often referred 
                    to as rangeways. The Allyn Street marker is the first of at least 
                    two, and hopefully more, permanent art installations in a series of 
                    split-rock gateways on the public paths to the shore or river edge. 
